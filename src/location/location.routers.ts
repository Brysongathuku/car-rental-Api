...
import {registerLocationController,getLocationController,getLocationByIdController,getLocationWithCarsController,updateLocationController,deleteLocationController} from "./location.controllers";
