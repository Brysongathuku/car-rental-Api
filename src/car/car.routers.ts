...
const car = (app: Express) => {
  ...
  app.route("/car/:id").get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route("/car-bookings/:id").get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route("/car/:id").put(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route("/car/:id").delete(adminRoleAuth, async (req, res, next) => {
    try {
