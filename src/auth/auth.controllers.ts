...
import { createCustomerService,verifyCustomerService,customerLoginService,getCustomerWithBookingsAndPaymentsService,getAllCustomersWithBookingsAndPaymentsService,getCustomerService, getCustomerByIdService,getCustomerByEmailService, updateCustomerService, deleteCustomerService } from './auth.services';
